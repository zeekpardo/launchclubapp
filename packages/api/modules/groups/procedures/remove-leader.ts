...
import { removeUserFromGroup, getGroupById, getSiteById, getAreaById, getUserSiteIds } from "@repo/database";
import { z } from "zod";
...
export const removeGroupLeader = protectedProcedure
  .route({ method: "DELETE", path: "/groups/{groupId}/leaders/{userId}", tags: ["Groups"] })
