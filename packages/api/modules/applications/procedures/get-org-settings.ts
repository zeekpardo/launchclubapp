...
export const getOrgApplicationSettingsProcedure = protectedProcedure
  ...
  .handler(async ({ input, context }) => {
    ...
    return settings ?? { autoMigrate: false, emailNotifications: false, studentIdMode: "auto", studentIdPrefix: "STU", enableConsentFileUpload: false, showObservationConsent: true, showTermsConsent: true, showPhotoVideoConsent: true, observationConsentFormUrl: null, termsConsentFormUrl: null, photoVideoConsentFormUrl: null };
  });
