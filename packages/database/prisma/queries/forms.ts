...
import type { FormType, FormStatus } from "../generated/enums";
  ...
  return db.form.findFirst({
    ...
    include: {
      fields: {
        orderBy: { order: "asc" },
        include: {
          customField: { select: { id: true, type: true, options: true } },
          consentItem: { select: { id: true, name: true, applicantType: true, pdfKey: true } },
        },
      },
